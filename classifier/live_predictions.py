...
MODEL_DIR_PATH = str(working_dir_path) + '\\classifier\\model\\'
...
if __name__ == '__main__':
    ...
    live_prediction.loaded_model.summary()
    live_prediction.make_predictions()
    live_prediction = LivePredictions(file=EXAMPLES_PATH + 'calm.wav')
    live_prediction.make_predictions()
    live_prediction = LivePredictions(file=EXAMPLES_PATH + 'happy.wav')
    live_prediction.make_predictions()
